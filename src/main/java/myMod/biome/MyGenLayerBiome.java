...
public class MyGenLayerBiome extends GenLayer
{
    ...
    // This constructor basically adds our biome to the list of biomes to be generated.
    public MyGenLayerBiome(long p_i2122_1_, GenLayer p_i2122_3_, WorldType p_i2122_4_)
    {
        super(p_i2122_1_);
        ...
        if (p_i2122_4_ == WorldType.DEFAULT_1_1)
        {
            ...
            // Here we add our own biome.
            biomes[desertIdx].add(new BiomeEntry(MyMod.myBiome, 10));
        }
        else
        {
            ...
            biomes[desertIdx].add(new BiomeEntry(BiomeGenBase.plains, 10));
            // This makes sure our biome appears in all world types.
            biomes[desertIdx].add(new BiomeEntry(MyMod.myBiome, 10));
        }
    }
